...
<CardGroup cols={2}>
  ...
  <Card title="Stemme" icon="volume-2">
    Panelet sier hver brikke høyt — stemme **på hvilket som helst lokalt språk**, for tiden **17 støttet**, vi legger til flere på forespørsel! Hjelper små barn og de som ennå ikke leser. Inneholder alfabetbokstaver og steder (Hus, Skole, Butikk, Skog osv.)
  </Card>
