...
<CardGroup cols={2}>
  ...
  <Card title="Stem" icon="volume-2">
    De bediening spreekt elk kaartje uit — stem **in elke lokale taal**, momenteel **19 ondersteund** (inclusief Arabisch en Fins), we voegen er op verzoek meer toe! Helpt jonge kinderen en niet-lezers. Bevat letters van het alfabet en plaatsen (Huis, School, Winkel, Bos, enz.)
  </Card>
