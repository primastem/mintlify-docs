...
Vouw het speelbord uit of maak een 10×10 cm raster met tape of een marker. Plaats de robot op de startcel. Vraag het kind een programma te maken om één cel vooruit te bewegen. Als de verkeerde chip werd gekozen, breng de robot terug en stel voor na te denken over een nieuwe optie.
...
p/s: Bedankt voor het gebruik van PrimaSTEM en voor je getoonde interesse! We wachten op je feedback, [schrijf ons](contacts.md) over je ervaring en indrukken.
