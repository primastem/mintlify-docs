...
## Getting Acquainted With the Educational Set[​](#getting-acquainted-with-the-educational-set "Direct link to Getting Acquainted With the Educational Set")

### Where Can PrimaSTEM Be Used?[​](#where-can-primastem-be-used "Direct link to Where Can PrimaSTEM Be Used?")
...
### What Should You Know to Start?[​](#what-should-you-know-to-start "Direct link to What Should You Know to Start?")

Before using the set, we recommend teachers and parents read the [user manual](/docs/user_manual) and this guide. No special programming skills are required-the materials provide the foundation needed for teaching.

## Research and Value of the Set[​](#research-and-value-of-the-set "Direct link to Research and Value of the Set")
...
![main brif](\images\docs\assets\images\mainbrif_03-489b8096f127336f119eabe3ed779b1e.jpg)
...
### Why Wood?[​](#why-wood "Direct link to Why Wood?")
...
## Programming Concepts With PrimaSTEM[​](#programming-concepts-with-primastem "Direct link to Programming Concepts With PrimaSTEM")

PrimaSTEM’s physical chips are analogous to instructions in real programming languages, demonstrating important concepts.

### Algorithms[​](#algorithms "Direct link to Algorithms")
...
### Debugging (Error Correction)[​](#debugging-error-correction "Direct link to Debugging (Error Correction)")
...
## Application in Other Subjects[​](#application-in-other-subjects "Direct link to Application in Other Subjects")
...
## Getting to Know the Robot and Controller[​](#getting-to-know-the-robot-and-controller "Direct link to Getting to Know the Robot and Controller")

### Robot[​](#robot "Direct link to Robot")
...
![robot](\images\docs\assets\images\robot.excalidraw-94fd333e71b63d80db316f7c21c3ada3.svg)
...
![control](\images\docs\assets\images\control.excalidraw-9800ce32348d022239fec88f3a9f6220.svg)
...
### Command Chips[​](#command-chips "Direct link to Command Chips")
...
## 1 – The First Program[​](#1--the-first-program "Direct link to 1 – The First Program")

### Cause and Effect[​](#cause-and-effect "Direct link to Cause and Effect")
...
![forvard](\images\docs\assets\images\guide1a.excalidraw-a9a8bf3246495cea6733d6079deed2f3.svg)

### Clear Instructions[​](#clear-instructions "Direct link to Clear Instructions")

Repeat with each direction (**forward**, turn **left**, turn **right**) until the child recognizes each chip.

### The First Task[​](#the-first-task "Direct link to The First Task")
...
## 2 – Program and Debugging[​](#2--program-and-debugging "Direct link to 2 – Program and Debugging")

### Sequence of Events[​](#sequence-of-events "Direct link to Sequence of Events")

Set the goal two cells in front of the robot.

![task-forvard\*2](\images\docs\assets\images\guide2d.excalidraw-29db6deba62f9aafdc64c167b0f2b82d.svg)

Have the child compose a program of two chips to reach the goal.

![forvard\*2](\images\docs\assets\images\guide2a.excalidraw-5f3d653f6eb59a4c1324f0a85bee5cdd.svg)

### Sequence of Three Chips[​](#sequence-of-three-chips "Direct link to Sequence of Three Chips")

This time, the goal is one cell in front and one to the right.

![task-forvard-right-forvard](\images\docs\assets\images\guide2e.excalidraw-554c2ff82daf7afe4a98855ee1f75d02.svg)

Invite the child to select the correct sequence of commands.

![forvard-right-forvard](\images\docs\assets\images\guide2b.excalidraw-0f6c72040eff95f493c6fab94f254224.svg)
...
### Debugging-Finding the Error[​](#debugging-finding-the-error "Direct link to Debugging-Finding the Error")

Set a destination one square ahead and one square to the left of the robot.

![task-forvard-left-forvard](\images\docs\assets\images\guide2f.excalidraw-391e7b87f4c0bf7b0ac34b97ac2fbebd.svg)
...
![forvard-left-forvard](\images\docs\assets\images\guide2с.excalidraw-f41bb05ce62fab91e803153b9069ca12.svg)

## 3 – Program With Function[​](#3--program-with-function "Direct link to 3 – Program With Function")

### The “Function” Command[​](#the-function-command "Direct link to The “Function” Command")
...
![forvard\*2](\images\docs\assets\images\guide3a.excalidraw-c6138917299a3ba59b50b82530b022b3.svg)
...
![function-forvard\*2](\images\docs\assets\images\guide3b.excalidraw-a466f2c4eb0b8509ec283b60a3e377ad.svg)

Next, create the sequence: **Forward – Forward – Right – Forward – Forward**.

![forvard2-right-forvard2](\images\docs\assets\images\guide3c.excalidraw-1426aee6180e16ca248c0754ec67c903.svg)
...
![function-right-function](\images\docs\assets\images\guide3d.excalidraw-ddfd91015c1a8bb7951e7b89b45a59b9.svg)

### Solving Tasks With Function[​](#solving-tasks-with-function "Direct link to Solving Tasks With Function")

Give the child three “**Forward**” chips and two “**Function**” chips.

![chip-forwards-functions](\images\docs\assets\images\guide3e.excalidraw-f8eaff4628c769299a2c22595af77065.svg)

The task is to move forward five squares.

![goal-5step](\images\docs\assets\images\guide3f.excalidraw-912c822bf3c9216fdc093ccb5469648f.svg)
...
![function-task](\images\docs\assets\images\guide3g.excalidraw-c8afcc087928a331689207bf597fde3c.svg)

## 4 – Randomness[​](#4--randomness "Direct link to 4 – Randomness")

### The “Random Direction” Command[​](#the-random-direction-command "Direct link to The “Random Direction” Command")
...
![rnd-move](\images\docs\assets\images\guide4a.excalidraw-0c55895baa80e4222d27d68f64437fa4.svg)
...
## 5 – Loops (Command Repeats)[​](#5--loops-command-repeats "Direct link to 5 – Loops (Command Repeats)")

### Getting to Know Numeric Loops[​](#getting-to-know-numeric-loops "Direct link to Getting to Know Numeric Loops")

Show the children value chips, ask if they know numbers, have ever seen dice for board games, or played such games.

![repeat-chips](\images\docs\assets\images\guide5a.excalidraw-5c657b3c88298426dbe47ca41b12fad7.svg)

Put two “Forward” chips in the top row and run-the robot moves two cells.

![forvard\*2](\images\docs\assets\images\guide5b.excalidraw-ce0cc7b447fbcdd31cd6ffc504d489a3.svg)

Now, leave one “Forward,” and put a “repeat 2” chip under it. The result is the same: the action is repeated twice.

![forvard-repeat2](\images\docs\assets\images\guide5c.excalidraw-82bff6cd9ed9220810d6f89bf86474ba.svg)
...
![repeat-task](\images\docs\assets\images\guide5d.excalidraw-916cd90c0bc7bbb80346b0470a0de3a1.svg)

### Function Call in a Loop[​](#function-call-in-a-loop "Direct link to Function Call in a Loop")
...
![step-task](\images\docs\assets\images\guide5e.excalidraw-cff641b27357522f54bbb1cec7a29b25.svg)

The robot will move diagonally as a staircase, making 5 steps.

![step-task-result](\images\docs\assets\images\guide5f.excalidraw-c91b591bbd47bd688f7117d992437afa.svg)

## 6 – Random Numbers[​](#6--random-numbers "Direct link to 6 – Random Numbers")

### The Concept of a Random Number[​](#the-concept-of-a-random-number "Direct link to The Concept of a Random Number")
...
![rnd-repeat-chip](\images\docs\assets\images\guide6a.excalidraw-9e8d0abf6ed7256b29e2d7b39a2b3251.svg)
...
![rnd-forvard](\images\docs\assets\images\guide6b.excalidraw-50a69e9de77cf3efc85747e81eb53a00.svg)
...
## 7 – Numbers: Distances and Angles[​](#7--numbers-distances-and-angles "Direct link to 7 – Numbers: Distances and Angles")

### Getting to Know Numbers[​](#getting-to-know-numbers "Direct link to Getting to Know Numbers")
...
![example1](\images\docs\assets\images\example1.excalidraw-4fe241bd2e9c8e2b847b2779ab4135ab.svg)
...
Changing parameters enables more complex trajectories and movement scenarios. See examples on the [mathematical drawings page](/docs/math_drawings).

## 8 – Arithmetic[​](#8--arithmetic "Direct link to 8 – Arithmetic")

### Arithmetic Operations[​](#arithmetic-operations "Direct link to Arithmetic Operations")
...
![example2](\images\docs\assets\images\example2.excalidraw-c4916c7671bfb7894f827f30abdce4e8.svg)
...
Pattern examples are shown on the [mathematical drawings page](/docs/math_drawings).

***

## Play and learn with children\![​](#play-and-learn-with-children "Direct link to Play and learn with children!")
...
p/s: Thank you for using PrimaSTEM and for your interest! We look forward to your feedback: [write to us](/docs/contacts) about your experience and impressions.
