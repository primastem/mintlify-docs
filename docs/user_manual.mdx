---
title: "User Manual"
description: "PrimaSTEM - a set for teaching children aged 4 to 12 the basics of logic, programming, and mathematics."
---

## Technical Specifications and Package Contents[​](#technical-specifications-and-package-contents "Direct link to Technical Specifications and Package Contents")

![primastem](\images\docs\assets\images\photo_2_2025-02-10_17-39-32-6cc0b4adb7a30953a8fda68a4b775de8.png)
...
### Game Robot[​](#game-robot "Direct link to Game Robot")

Dimensions: D=125 mm, H=45 mm.

![robot](\images\docs\assets\images\photo_2025-02-10_17-38-46-ee7c0db415f7125a06eb4b66729d6f91.png)
...
![control](\images\docs\assets\images\photo_29_2025-02-10_17-39-32-8328cb60518818b979bdbbb45127b98d.png)

The controller features 11 dual slots for installing command and value chips: 6 for the main program (top row), 5 for the subroutine (bottom row). The controller has two buttons: on the left-power, on the right-“Execute / Stop” to start and stop the program.
...
### Chips – Instructions[​](#chips--instructions "Direct link to Chips – Instructions")

Dimensions: LxW (or D)=30 mm.

The set includes chips for program creation. Each chip is a command with a clear value and instruction. The sequence of blocks determines the robot's behavior.

![coding chips](\images\docs\assets\images\Image16-af1f3e11853f62ae756bc1ff21dfb39e.jpg)
...
#### Value Chips[​](#value-chips "Direct link to Value Chips")

Angle and distance chips: 30°, 36°, 45°, and multiples (60°, 72°, etc.). Angles are in degrees, distances in millimeters. Defaults are 90° and 100 mm (10 cm).

#### Arithmetic Chips[​](#arithmetic-chips "Direct link to Arithmetic Chips")
...
## Connecting the Controller and Robot[​](#connecting-the-controller-and-robot "Direct link to Connecting the Controller and Robot")
...
To program movement, install command chips (e.g., “Forward”, “Left”, “Function”) into the controller's slots. You can set command values and repeat counts, as well as angles, distances, or arithmetic operations.
...
![control with chips](\images\docs\assets\images\manual1a.excalidraw-399495d2b9e5518e22cf5ad38fad4b4f.svg)
