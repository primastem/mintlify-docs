...
| ------- | ----------------------------------- | -------------------------------------------------------------------------------------------- |
| Forward   | ![](images/forward.excalidraw.svg)  | The robot advances one cell — a logical step (by default equal to 15 cm)              |
| Left  | ![](images/left.excalidraw.svg)     | The robot turns 90° left                                                           |
| Right | ![](images/right.excalidraw.svg)    | The robot turns 90° right                                                          |
| Back   | ![](images/back.excalidraw.svg)     | The robot drives back one cell — a logical step by default                                |
| Function | ![](images/function.excalidraw.svg) | The robot executes the sequence of commands located in the function line                    |
| Repeat № | ![](images/repeatN.excalidraw.svg)  | The robot repeats the command set in the paired cell a certain number of times — №      |
...
| Image                                        | Description                                                                    |
| -------------------------------------------------- | --------------------------------------------------------------------------- |
| ![](images/forward.excalidraw.svg) | The **"Forward"** command token makes the robot move one cell |
...
| Image                                     | Description                                                                                                                                                                                |
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](images/left.excalidraw.svg) | The token with an arrow turning in an arc around the center is **"Left"** — it makes the robot turn left, counterclockwise. The default rotation step is 90 degrees. |
...
| Image                                      | Description                                                     |
| ------------------------------------------------ | ------------------------------------------------------------ |
| ![](images/right.excalidraw.svg) | The **"Right"** token makes the robot turn right. |
