...
Changing parameters enables more complex trajectories and movement scenarios. See examples on the [mathematical drawings page](math_drawings.mdx).
...
Pattern examples are shown on the [mathematical drawings page](math_drawings.mdx).
...
p/s: Thank you for using PrimaSTEM and for your interest! We look forward to your feedback: [write to us](contacts.mdx) about your experience and impressions.
