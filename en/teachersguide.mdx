...
Set up the game board or create a 10x10 cm grid using tape or a marker. Place the robot on the starting cell. Ask the child to create a program to move forward one cell. If the wrong chip was chosen, return the robot and suggest reasoning about a new option.
