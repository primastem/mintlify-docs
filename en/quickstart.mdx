...
<CardGroup cols={2}>
  ...
  <Card title="Voice feedback" icon="volume-2">
    The board reads each token aloud — voice in **any local language**, currently **18 supported** (including Arabic), we'll add any on request. Helps young and pre-reading children. Includes alphabet letters and places (Home, School, Shop, Forest, etc.)
  </Card>
