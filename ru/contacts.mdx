---
title: "Наши контакты"
description: "Обратите внимание, что нашими рабочими языками являются английский, французский и русский. Использование других языков может привести к дополнительным задержкам ;)"
icon: "map"
mode: "default"
---

Почта - [info@primastem.com](mailto:info@primastem.com) 
