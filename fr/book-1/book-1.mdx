...
| ------- | ----------------------------------- | -------------------------------------------------------------------------------------------- |
| Tout droit | ![](images/forward.excalidraw.svg)  | Le robot avance d'une case — un pas logique (par défaut égal à 15 cm)              |
| À gauche  | ![](images/left.excalidraw.svg)     | Le robot tourne de 90° à gauche                                                           |
| À droite | ![](images/right.excalidraw.svg)    | Le robot tourne de 90° à droite                                                          |
| En arrière | ![](images/back.excalidraw.svg)     | Le robot recule d'une case — un pas logique par défaut                                |
| Fonction | ![](images/function.excalidraw.svg) | Le robot exécute la séquence de commandes située dans la ligne de fonction                    |
| Répétition № | ![](images/repeatN.excalidraw.svg)  | Le robot répète la commande installée dans la cellule jumelée un certain nombre de fois — №      |
...
| Image                                              | Description                                                                    |
| -------------------------------------------------- | --------------------------------------------------------------------------- |
| ![](images/forward.excalidraw.svg) | Le jeton de commande **« Avancer »** fait avancer le robot d'une case |
...
| Image                                           | Description                                                                                                                                                                                |
| ----------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](images/left.excalidraw.svg) | Le jeton avec une flèche tournant en arc de cercle autour du centre — **« Gauche »** fait tourner le robot à gauche, dans le sens inverse des aiguilles d'une montre. Le pas de rotation par défaut est de 90 degrés. |
...
| Image                                            | Description                                                     |
| ------------------------------------------------ | ------------------------------------------------------------ |
| ![](images/right.excalidraw.svg) | Le jeton **« Droite »** fait tourner le robot à droite. |
