...
Avant d'utiliser le kit, nous recommandons aux enseignants et aux parents de lire le [manuel d'utilisation](usermanual) et ce guide. Aucune compétence particulière en programmation n'est requise - les documents fournissent les bases nécessaires à l'enseignement.
