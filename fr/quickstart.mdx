...
<CardGroup cols={2}>
  ...
  <Card title="Voix" icon="volume-2">
    La télécommande énonce chaque jeton — voix dans **n'importe quelle langue locale**, actuellement **19 supportées** (dont l'arabe et le finnois), nous en ajoutons d'autres sur demande ! Aide les jeunes enfants et les non-lecteurs. Inclut les lettres de l'alphabet et des lieux (Maison, École, Magasin, Forêt, etc.)
  </Card>
