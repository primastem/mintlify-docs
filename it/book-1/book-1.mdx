...
| Attività | Comprensione dei concetti di algoritmo e programma | Suddivisione del percorso in tappe | Previsione dello spostamento | Risoluzione dei problemi, debug del programma | Lavoro di squadra, collaborazione |
| --- | :---: | :---: | :---: | :---: | :---: |
| 1 |   | X |   | X |   |
| 2 |   |   | X |   | X |
| 3 | X | X |   |   |   |
