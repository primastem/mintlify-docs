...
| Aktivitet | Förståelse av begreppen algoritm och program | Uppdelning av rutten i etapper | Förutse rörelse | Problemlösning, felsökning i programmet | Teamarbete, samarbete |
| --- | :---: | :---: | :---: | :---: | :---: |
| 1 |   | X |   | X |   |
| 2 |   |   | X |   | X |
| 3 | X | X |   |   |   |
