...
<CardGroup cols={2}>
  ...
  <Card title="Sprachausgabe" icon="volume-2">
    Die Steuerung spricht jedes Token aus — Stimme **in beliebigen lokalen Sprachen**, derzeit **19 unterstützt** (einschließlich Arabisch und Finnisch), weitere auf Anfrage! Hilft kleinen Kindern und Nichtlesern. Mit Alphabet-Buchstaben und Orten (Haus, Schule, Laden, Wald usw.)
  </Card>
